...
export default function AboutPage() {
  const features = [
    ...
    },
    {
      ...
      description:
        'From early-stage fundraising to later rounds, we support portfolio companies in refining their investor pitch, navigating term sheets, and accessing a trusted network of venture and strategic capital.',
    },
    {
    ...
    },
    {
      ...
      description:
        'We assist founders in aligning product strategy with customer needs and market dynamics—offering perspective on prioritization, roadmap planning, and feature-market fit.',
    },
    {
    ...
    },
    {
      title: 'Marketing',
      description:
        'We collaborate on brand positioning, growth campaigns, and customer acquisition strategies to help teams establish market presence and accelerate user growth.',
    },
    {
      title: 'Communications',
      description:
        'We support internal and external communications strategy—from messaging and media relations to crisis response and thought leadership—to help founders shape perception and build trust.',
    },
  ];
  ...
  const handleToggle = (showSubSector: boolean) => {
    setShowSubSectors(showSubSector);
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 40 }}>
            <div style={{
              ...
              <button
                ...
                style={{
                  background: !showSubSectors ? 'rgba(255,255,255,0.05)' : 'transparent',
                  border: 'none',
                  borderRadius: '6px',
                  padding: '10px 20px',
                  color: 'white',
            ...
            {!showSubSectors ? (
              <div style={{
                ...
                <div className="subsector-card" style={{
                  ...
                  <div className="subsector-desc-overlay">
                  ...
                  <span style={{ display: 'block', marginBottom: 10 }}>
                    <svg width="52" height="52" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <g stroke="#FFD700" strokeWidth="2" strokeLinecap="round">
                        ...
                        <line x1="30.5" y1="7.5" x2="26.5" y2="11.5" />
                        <line x1="7.5" y1="30.5" x2="11.5" y2="26.5" />
                        <line x1="30.5" y1="30.5" x2="26.5" y2="26.5" />
                      </g>
                    </svg>
                  </span>
                  <h3 className="subsector-title" style={{ color: 'white', fontSize: '1.25rem', marginBottom: 12, zIndex: 1 }}>
