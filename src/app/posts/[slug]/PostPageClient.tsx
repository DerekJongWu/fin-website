  ...
  return (
    <div style={{ display: 'flex', gap: '18px', alignItems: 'center' }}>
      ...
      <button
        ...
        onClick={() => window.open(`https://twitter.com/intent/tweet?url=${encodeURIComponent(postUrl)}`, '_blank', 'noopener,noreferrer')}
      ...
      <button
        style={{ background: 'none', border: 'none', padding: 0, cursor: 'pointer' }}
        onClick={() => window.open(`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(postUrl)}`, '_blank', 'noopener,noreferrer')}
